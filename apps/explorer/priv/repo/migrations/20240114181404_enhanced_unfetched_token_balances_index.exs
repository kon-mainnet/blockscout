defmodule Explorer.Repo.Migrations.EnhancedUnfetchedTokenBalancesIndex do
  ...
  def up do
    execute("""
      ...
      WHERE (
          ((address_hash != '\\x0000000000000000000000000000000000000000' AND token_type = 'ERC-721') OR token_type = 'KONET-20' OR token_type = 'ERC-1155') AND (value_fetched_at IS NULL OR value IS NULL)
      );
    """)
  end
